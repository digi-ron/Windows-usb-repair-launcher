...
$filename = "$($fileoutPath)\$($PCName)--$($UserName)--$($TDStamp)--REGPKEY.reg"

reg export "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\SoftwareProtectionPlatform" $filename